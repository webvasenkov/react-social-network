    ...
    return (
        <div className={classNames('pagination', className)}>
            <div className="pagination__wrapper">
                <svg className="pagination__button pagination__button-prev pagination__button_disabled" width="18" height="12" viewBox="0 0 18 12"
                ...
                <svg className="pagination__button pagination__button-next pagination__button_enabled" width="18" height="12" viewBox="0 0 18 12"
                     fill="#FFF" xmlns="http://www.w3.org/2000/svg">
                    <path
